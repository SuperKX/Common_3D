...
if __name__ == "__main__":
    ...
    if False:  # 批量处理
        # 0 参数修改
        dataset_root = r'/media/xuek/Data210/数据集/训练集/重建数据_版本2025.10.15'
        output_root = r'/home/xuek/桌面/TestData/PTV3_data/重建数据_版本2025.10.15_5class_1113'
        sample_grid = 0.4  # 采样大小：注意此处写死
        label_dict_input = label_dict.label_map_l12v1_to_l05v1
